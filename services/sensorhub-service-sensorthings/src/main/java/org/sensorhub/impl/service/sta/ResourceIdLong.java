 ...
 * @date Sep 7, 2019
 */
public class ResourceIdLong implements ResourceId
{
    ...
    protected ResourceIdLong()
    {        
    }
    
    
    public ResourceIdLong(long internalID)
    {
    ...
    public ResourceIdLong(String idString)
    {
    ...
    {
        return BigInteger.valueOf(internalID);
    }
