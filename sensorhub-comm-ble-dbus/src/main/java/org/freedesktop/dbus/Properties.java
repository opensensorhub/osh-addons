...
{
    @DBusInterfaceName("org.freedesktop.DBus.Properties.PropertiesChanged")
    public class PropertiesChanged extends DBusSignal
    {
        ...
        public PropertiesChanged(String interface_name, Map<String,Variant<?>> changed_properties, List<String> invalidated_properties) throws DBusException
        {
           super("/", changed_properties, invalidated_properties);
