...
public class WaterTempCelsiusOutput extends AbstractSensorOutput <USGSWaterDriver> implements IMultiSourceDataInterface
{
    ...
    {   
        ...
        dataStruct.addField("water_temp", swe.newQuantity(SWEHelper.getPropertyUri("WaterTemperature"), "Water Temperature", "Water Temperature parameter, USGS code 00010", "Cel"));
    ...
    public void publishData(List<USGSDataRecord> dataRec)
    {
    	for (USGSDataRecord rec : dataRec)
    	{
    		...
    		eventHandler.publishEvent(new SensorDataEvent(latestRecordTime, rec.getSiteCode(), WaterTempCelsiusOutput.this, latestRecord));
    	}
    }
