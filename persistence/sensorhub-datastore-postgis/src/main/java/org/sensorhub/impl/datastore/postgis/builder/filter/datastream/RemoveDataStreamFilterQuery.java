...
public class RemoveDataStreamFilterQuery extends DataStreamFilterQuery<RemoveFilterQueryGenerator> {
    private Long dsId;

    public RemoveDataStreamFilterQuery(String tableName, RemoveFilterQueryGenerator filterQueryGenerator) {
