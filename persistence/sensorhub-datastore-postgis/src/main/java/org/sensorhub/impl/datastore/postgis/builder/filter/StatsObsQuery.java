...
public class StatsObsQuery extends StatsQuery {
    ...
    protected static abstract class Init<T extends StatsObsQuery.Init<T>> extends StatsQuery.Init<T> {
        private IFoiStore foiStore;
        private ISystemDescStore systemDescStore;
        ...
        public T withObsStatsFilter(ObsStatsQuery filter) {
            ...
            if(obsFilter != null) {
                ObsStatsFilterQuery obsFilterQuery = new ObsStatsFilterQuery(this.tableName, filterQueryGenerator);
    ...
    public static class Builder extends StatsObsQuery.Init<StatsObsQuery.Builder> {
        @Override
        protected StatsObsQuery.Builder self() {
            return this;
        }
    }

    protected StatsObsQuery(StatsObsQuery.Init<?> init) {
        super(init);
