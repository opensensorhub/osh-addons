...
public class RemoveProcedureFilterQuery extends BaseFeatureFilterQuery<IProcedureWithDesc, ProcedureFilter, RemoveFilterQueryGenerator> {

    public RemoveProcedureFilterQuery(String tableName, RemoveFilterQueryGenerator filterQueryGenerator) {
        super(tableName, filterQueryGenerator);
    }

    @Override
    public RemoveFilterQueryGenerator build(ProcedureFilter filter) {
