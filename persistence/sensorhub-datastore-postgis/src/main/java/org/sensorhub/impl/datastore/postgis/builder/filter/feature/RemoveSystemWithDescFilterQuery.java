...
public class RemoveSystemWithDescFilterQuery extends BaseSystemWithDescFilterQuery<RemoveFilterQueryGenerator> {

    public RemoveSystemWithDescFilterQuery(String tableName, RemoveFilterQueryGenerator filterQueryGenerator) {
