...
public class RemoveDeploymentFilterQuery extends DeploymentFilterQuery<RemoveFilterQueryGenerator> {

    public RemoveDeploymentFilterQuery(String tableName, RemoveFilterQueryGenerator filterQueryGenerator) {
        super(tableName, filterQueryGenerator);
    }

    public RemoveFilterQueryGenerator build(DeploymentFilter filter) {
    ...
    protected void handleSystemFilter(SystemFilter parentFilter) {
        if (parentFilter != null) {
            ...
            if(parentFilter.getUniqueIDs() != null) {
                ...
                this.filterQueryGenerator.addCondition(this.tableName + ".parentId" + " = "+this.sysDescTableName+".id");
