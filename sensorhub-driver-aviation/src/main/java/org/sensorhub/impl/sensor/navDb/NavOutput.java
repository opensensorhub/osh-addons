 ...
 *
 */
public class NavOutput extends AbstractSensorOutput<NavSensor> implements IMultiSourceDataInterface 
{
	...
	public NavOutput(NavSensor parentSensor) throws IOException
	{
		super(parentSensor);
	}
	...
	protected void init()
	{
		...
		Text id = fac.newText("http://sensorml.com/ont/swe/property/code", "ICAO Code", "ICAO airline code");
	...
	{                
		...
		for(NavDbEntry rec: recs) {
			...
			String uid = NavSensor.AIRPORTS_UID_PREFIX + rec.id;
			records.put(uid, dataBlock);   
			long time = System.currentTimeMillis();
			eventHandler.publishEvent(new SensorDataEvent(time, NavOutput.this, dataBlock));
		}
	}
