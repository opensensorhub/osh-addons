...
public class MeshSensor extends AbstractSensorModule<MeshConfig> implements FileListener
{
	...
	public void init() throws SensorHubException
	{
		...
		try {
			...
			e.printStackTrace();
			throw new SensorHubException("Cannot instantiate MeshOutput", e);
		}        
	...
	public void start() throws SensorHubException
	{
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			throw new SensorHubException("MeshSensor could not create DirectoryWatcher...", e);
		}
	}
