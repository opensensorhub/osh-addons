...
public class i2cConfig {
    ...
    @DisplayInfo.Required
    @DisplayInfo(label="Sensor Address", desc="Provide the Register Address for the Sensor. Most likely 0x17 unless changed manually")
    public int SENSOR_ADDRESS = 0x17;
}
