...
/**
 * Configuration settings for the Sony SNC VB600 driver exposed via the OpenSensorHub Admin panel.
 */
public class VB600Config extends SensorConfig {
    /**
     * The serial number or unique identifier for the configured camera.
     */
    @DisplayInfo.Required
    @DisplayInfo(label = "Serial Number", desc = "Serial number of the Sony SNC VB600 camera, used to uniquely identify the sensor.")
    ...
    public VB600ConfigConnection connection = new VB600ConfigConnection();
