...
public class TestRTPCameraDriverVirbXE implements IEventListener
{
    ...
    public void init() throws Exception
    {
        ...
        /*// discover live preview URL
        URLConnection conn = new URL("http://192.168.0.17/virb").openConnection();
        conn.setDoOutput(true);
        conn.getOutputStream().write("{\"command\":\"livePreview\",\"streamType\": \"rtp\"}".getBytes());
