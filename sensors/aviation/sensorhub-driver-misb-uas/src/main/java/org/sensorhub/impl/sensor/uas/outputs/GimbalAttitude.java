 ...
 * @since Oct. 6, 2020
 */
public class GimbalAttitude<UasConfigType extends UasConfig> extends UasOutput<UasConfigType> {
     ...
     */
    public GimbalAttitude(UasSensorBase<UasConfigType> parentSensor) {
