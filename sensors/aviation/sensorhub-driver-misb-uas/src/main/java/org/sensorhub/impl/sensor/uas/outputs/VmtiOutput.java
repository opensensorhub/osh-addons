    ...
    public void init() {
        ...
        dataStruct = swe.createRecord()
            ...
            .addField("frameNum", swe.createCount()
                .definition(UasHelper.MISB_DEF_ROOT + "FrameNumber")
                .label("Frame Number"))
            .addField("numTargets", swe.createCount()
                .definition(UasHelper.MISB_DEF_ROOT + "NumTargetsReported")
                .label("Number of Targets")
                .id(numTargetsID))
            .addField("targetSeries", swe.createArray()
                .definition(UasHelper.MISB_DEF_ROOT + "TargetSeries")
                .withVariableSize(numTargetsID)
                .withElement("target", swe.createRecord()
                    .addField("id", swe.createCount()
                        .definition(UasHelper.MISB_DEF_ROOT + "TargetId"))
                    .addField("centroid", swe.createVector()
                        .definition(UasHelper.MISB_DEF_ROOT + "TargetCentroid")
                    ...
                    .addField("location", swe.createLocationVectorLLA()
                        .definition(UasHelper.MISB_DEF_ROOT + "TargetLocation")
