 ...
 * @since Oct. 6, 2020
 */
public class Identification<UasConfigType extends UasConfig> extends UasOutput<UasConfigType> {
     ...
     */
    public Identification(UasSensorBase<UasConfigType> parentSensor) {
