...
public class Identification extends UasOutput {
    ...
    private static final String SENSOR_OUTPUT_NAME = "Identification";
    private static final String SENSOR_OUTPUT_LABEL = "Identification";
    private static final String SENSOR_OUTPUT_DESCRIPTION = "Platform identification as Decoded from MPEG-TS MISB STANAG 4609 Metadata";
