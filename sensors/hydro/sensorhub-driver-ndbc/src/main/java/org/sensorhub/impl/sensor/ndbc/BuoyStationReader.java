...
/**
 * Reads station information from ndbc. 
 * Currently unused- needs to be integrated into driver.
 * 
 * @author Tony Cook
 */
...
public class BuoyStationReader {
	...
	public static List<BuoyStationRecord> readStations(String stationUrl) throws IOException {
