...
package org.sensorhub.test.impl.sensor.intelipod;
...
import org.sensorhub.impl.sensor.intelipod.IntelipodSensor;
...
public class TestIntelipodDriver implements IEventListener
{
    IntelipodSensor driver;
    IntelipodConfig config;	
    ...
    {
        System.out.println();
        IStreamingDataInterface output = driver.getObservationOutputs().get("intelipodData");
