...
/**
 * Provides base functionality for defining and publishing sensor outputs
 ...
 * @since Mar 20, 2023
 */
public abstract class RosSensorOutput<SensorType extends ISensorModule<?>> extends BaseRosOutput<SensorType> {

    /**
     * SWE Common Data record
     */
     ...
     */
    protected RosSensorOutput(String name, SensorType parentSensor, Logger log) {
