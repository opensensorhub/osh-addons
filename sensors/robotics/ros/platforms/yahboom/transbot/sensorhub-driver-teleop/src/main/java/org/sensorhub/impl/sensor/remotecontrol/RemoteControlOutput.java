 ...
 * @since Feb. 2, 2023
 */
public class RemoteControlOutput extends RosSensorOutput<RemoteControlSensor> {

    private static final String SENSOR_OUTPUT_NAME = "CommandVel";
    private static final String SENSOR_OUTPUT_LABEL = "Command Vel";
    private static final String SENSOR_OUTPUT_DESCRIPTION = "Resulting command velocity of remote control operation";

    private static final String NODE_NAME_STR = "/SensorHub/remoteControl/commandVel";

    private static final String TOPIC_STR = "/cmd_vel";

    private static final Logger logger = LoggerFactory.getLogger(RemoteControlOutput.class);
     ...
     * Constructor
     *
     * @param remoteControlSensor Sensor driver providing this output
     */
    RemoteControlOutput(RemoteControlSensor remoteControlSensor) {

        super(SENSOR_OUTPUT_NAME, remoteControlSensor, logger);
    ...
    public void onNewMessage(Object object) {
        ...
        eventHandler.publish(new DataEvent(latestRecordTime, RemoteControlOutput.this, dataBlock));
    }
