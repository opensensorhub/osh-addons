...
public class DefaultNavButton extends DefaultButton {

    public DefaultNavButton(final ButtonManager buttonManager, final String name, int buttonIdx) {
        super(buttonManager, ButtonClass.NAV, name, buttonIdx);
    }
}
