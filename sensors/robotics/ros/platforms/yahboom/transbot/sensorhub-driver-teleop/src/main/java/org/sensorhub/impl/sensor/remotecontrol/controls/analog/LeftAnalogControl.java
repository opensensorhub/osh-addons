...
public class LeftAnalogControl extends DefaultAnalogControl {

    public LeftAnalogControl(AnalogControlManager analogControlDataManager, int horizontalIdx, int verticalIdx) {

        super(analogControlDataManager, ControlPlacement.LEFT, horizontalIdx, verticalIdx);
    }
}
