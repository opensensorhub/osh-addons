 ...
 * @since Sept. 25, 2023
 */
public class TriggerSvcClient extends RosServiceClient<TriggerRequest, TriggerResponse> implements ServiceResponseListener<TriggerResponse> {
     ...
     */
    public TriggerSvcClient(BaseSpotControl parentControl, String nodeName, String serviceName) {
        super(nodeName, serviceName, Trigger._TYPE);
