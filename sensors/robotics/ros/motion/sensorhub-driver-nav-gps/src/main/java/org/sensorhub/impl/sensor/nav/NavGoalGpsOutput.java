 ...
 * @since Mar. 7, 2023
 */
public class NavGoalGpsOutput extends RosSensorOutput<NavGoalSensor> {

    private static final String SENSOR_OUTPUT_NAME = "NavGPS";
    private static final String SENSOR_OUTPUT_LABEL = "Nav GPS";
    private static final String SENSOR_OUTPUT_DESCRIPTION = "Nav GPS Position";

    private static final String NODE_NAME_STR = "/SensorHub/navGps";

    private static final String TOPIC_STR = "/fix";

    private static final Logger logger = LoggerFactory.getLogger(NavGoalGpsOutput.class);
     ...
     * Constructor
     *
     * @param parentNavGoalSensor Sensor driver providing this output
     */
    NavGoalGpsOutput(NavGoalSensor parentNavGoalSensor) {

        super(SENSOR_OUTPUT_NAME, parentNavGoalSensor, logger);
    ...
    public void onNewMessage(Object object) {
        ...
        eventHandler.publish(new DataEvent(latestRecordTime, NavGoalGpsOutput.this, dataBlock));
    }
