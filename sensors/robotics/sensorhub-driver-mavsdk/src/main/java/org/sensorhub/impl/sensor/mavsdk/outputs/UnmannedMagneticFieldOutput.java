 ...
 */
public class UnmannedMagneticFieldOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "MagneticFieldOutput";
     ...
     */
    public UnmannedMagneticFieldOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedMagneticFieldOutput.this, dataBlock));
        }
    }
