 ...
 */
public class UnmannedAccelerationOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "AccelerationOutput";
    static final String SENSOR_OUTPUT_LABEL = "Acceleration";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem acceleration output data";
     ...
     */
    public UnmannedAccelerationOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedAccelerationOutput.this, dataBlock));
        }
    }
