 ...
 */
public class UnmannedHealthGpsOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "GpsHealthOutput";
    static final String SENSOR_OUTPUT_LABEL = "GpsHealth";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem GPS health output data";
     ...
     */
    public UnmannedHealthGpsOutput(UnmannedSystem parentSensor) {
    ...
    public void setData(Telemetry.GpsInfo info, long timestamp) {
        synchronized (processingLock) {
            ...
            try {
                ...
                if (info != null) {
                    ...
                    dataBlock.setIntValue(index++, info.getNumSatellites());
                }
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedHealthGpsOutput.this, dataBlock));
        }
    }
    ...
    public void subscribe(io.mavsdk.System drone) {
        ...
        drone.getTelemetry().getGpsInfo()
                .subscribe(gpsInfo-> {

                    setData(gpsInfo, System.currentTimeMillis());
                });
