...
/**
 * UnmannedStatusTextOutput specification and provider for {@link UnmannedSystem}.
 */
public class UnmannedStatusEventOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "UnmannedStatusTextOutput";
    static final String SENSOR_OUTPUT_LABEL = "StatusEvent";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem status text output data";
     ...
     */
    public UnmannedStatusEventOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp, Telemetry.StatusText status ) {
        synchronized (processingLock) {
            ...
            try {
                ...
                if ( status != null ) {
                    ...
                    dataBlock.setStringValue(index++, status.getType().toString() );
                    dataBlock.setStringValue(index++, status.getText() );
                }
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedStatusEventOutput.this, dataBlock));
        }
    }
    ...
    public void subscribe(io.mavsdk.System drone ) {
        drone.getTelemetry().getStatusText()
                .subscribe(
                        status -> {
