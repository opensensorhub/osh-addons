...
/**
 * UnmannedAbRelOutput specification and provider for {@link UnmannedSystem}.
 */
public class UnmannedAbRelAltitudeOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "UnmannedAbRelOutput";
    static final String SENSOR_OUTPUT_LABEL = "AbRelOutput";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem absolute relative output data";
     ...
     */
    public UnmannedAbRelAltitudeOutput(UnmannedSystem parentSensor) {
        ...
        synchronized (processingLock) {
            ...
            try {
                ...
                if ( currentPosition != null ) {
                    ...
                    //Relative Altitude
                    dataBlock.setDoubleValue(index++, currentPosition.getRelativeAltitudeM());
                }
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedAbRelAltitudeOutput.this, dataBlock));
        }
    }
