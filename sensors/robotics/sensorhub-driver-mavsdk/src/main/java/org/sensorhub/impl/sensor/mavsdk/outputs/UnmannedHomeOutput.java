...
/**
 * UnmannedHomeOutput specification and provider for {@link UnmannedSystem}.
 */
public class UnmannedHomeOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "UnmannedHomeOutput";
    static final String SENSOR_OUTPUT_LABEL = "Home";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem home output data";
     ...
     */
    public UnmannedHomeOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedHomeOutput.this, dataBlock));
        }
    }
