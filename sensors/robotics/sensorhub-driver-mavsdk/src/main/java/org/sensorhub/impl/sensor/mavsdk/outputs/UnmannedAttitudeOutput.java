 ...
 */
public class UnmannedAttitudeOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "UnmannedAttitudeOutput";
    static final String SENSOR_OUTPUT_LABEL = "Attitude";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem attitude output data";
     ...
     */
    public UnmannedAttitudeOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedAttitudeOutput.this, dataBlock));
        }
    }
