 ...
 */
public class UnmannedAngularVelocityOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "AngularVelocityOutput";
    static final String SENSOR_OUTPUT_LABEL = "AngularVelocity";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem angular velocity output data";
     ...
     */
    public UnmannedAngularVelocityOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedAngularVelocityOutput.this, dataBlock));
        }
    }
