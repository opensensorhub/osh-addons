...
/**
 * UnmannedLocationOutput specification and provider for {@link UnmannedSystem}.
 */
public class UnmannedLocationOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "UnmannedLocationOutput";
    static final String SENSOR_OUTPUT_LABEL = "Location";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem location output data";
     ...
     */
    public UnmannedLocationOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedLocationOutput.this, dataBlock));
        }
    }
