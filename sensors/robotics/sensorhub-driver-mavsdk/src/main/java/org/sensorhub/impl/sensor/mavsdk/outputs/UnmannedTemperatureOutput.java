 ...
 */
public class UnmannedTemperatureOutput extends AbstractSensorOutput<UnmannedSystem> {
    static final String SENSOR_OUTPUT_NAME = "TemperatureOutput";
    static final String SENSOR_OUTPUT_LABEL = "Temperature";
    static final String SENSOR_OUTPUT_DESCRIPTION = "UnmannedSystem temperature output data";
     ...
     */
    public UnmannedTemperatureOutput(UnmannedSystem parentSensor) {
    ...
    public void setData( long timestamp ) {
        synchronized (processingLock) {
            ...
            eventHandler.publish(new DataEvent(latestRecordTime, UnmannedTemperatureOutput.this, dataBlock));
        }
    }
