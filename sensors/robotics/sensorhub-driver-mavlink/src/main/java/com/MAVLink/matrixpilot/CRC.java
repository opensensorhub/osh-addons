...
public class CRC {
    ...
    static {
        ...
        MAVLINK_MESSAGE_CRCS.put(150, 181);
        MAVLINK_MESSAGE_CRCS.put(151, 26);
        MAVLINK_MESSAGE_CRCS.put(152, 101);
        MAVLINK_MESSAGE_CRCS.put(153, 109);
        MAVLINK_MESSAGE_CRCS.put(155, 12);
        MAVLINK_MESSAGE_CRCS.put(156, 218);
        MAVLINK_MESSAGE_CRCS.put(157, 133);
        MAVLINK_MESSAGE_CRCS.put(158, 208);
        MAVLINK_MESSAGE_CRCS.put(162, 189);
        MAVLINK_MESSAGE_CRCS.put(170, 103);
        MAVLINK_MESSAGE_CRCS.put(171, 245);
        MAVLINK_MESSAGE_CRCS.put(172, 191);
        MAVLINK_MESSAGE_CRCS.put(173, 54);
        MAVLINK_MESSAGE_CRCS.put(174, 54);
        MAVLINK_MESSAGE_CRCS.put(175, 171);
        MAVLINK_MESSAGE_CRCS.put(176, 142);
        MAVLINK_MESSAGE_CRCS.put(177, 249);
        MAVLINK_MESSAGE_CRCS.put(178, 123);
        MAVLINK_MESSAGE_CRCS.put(179, 7);
        MAVLINK_MESSAGE_CRCS.put(180, 222);
        MAVLINK_MESSAGE_CRCS.put(181, 55);
        MAVLINK_MESSAGE_CRCS.put(182, 154);
        MAVLINK_MESSAGE_CRCS.put(183, 175);
        MAVLINK_MESSAGE_CRCS.put(184, 41);
        MAVLINK_MESSAGE_CRCS.put(185, 87);
        MAVLINK_MESSAGE_CRCS.put(186, 144);
        MAVLINK_MESSAGE_CRCS.put(187, 134);
        MAVLINK_MESSAGE_CRCS.put(188, 91);
