...
/**
 * <p>
 * Multiplication of two 4x4 matrices and a scalar,
...
public class MulMat4Mat4_Process extends ExecutableProcessImpl
{
    ...
    public MulMat4Mat4_Process()
    {
        ...
        // create input M1
        mat1 = sweHelper.newMatrix(4, 4);
        inputData.add("M1", mat1);
        
        // create input M1
        mat2 = sweHelper.newMatrix(4, 4);
        ...
        resultMat = sweHelper.newMatrix(4, 4);
    ...
    public void execute() throws SMLException
    {
        ...
        VecMathHelper.toMat4d(mat2.getData(), m2);
        ...
        VecMathHelper.fromMat4d(m1, resultMat.getData());
    } 
}