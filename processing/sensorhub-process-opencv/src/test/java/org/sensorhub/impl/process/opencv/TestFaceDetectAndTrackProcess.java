...
public class TestFaceDetectAndTrackProcess
{
    ...
    protected static ISensorModule<?> createSensorDataSource1() throws Exception
    {
        ...
        sensorCfg.deviceName = "/dev/video2";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String smlUrl = TestFaceDetectAndTrackProcess.class.getResource("processchain-face-track.xml").getFile();
